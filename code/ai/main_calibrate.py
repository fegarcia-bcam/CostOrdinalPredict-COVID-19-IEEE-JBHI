...
from run_calibration import run_calibr_repeat_cv
...
def save_results_calibr_cv(decisor, opts_cv, opts_score, opts_pipe, hyperparams, seed,
    ...
    results = {'decisor': decisor, 'opts_cv': opts_cv, 'opts_score': opts_score,
               ...
               'y_pred_unclbr_repeat': [y_pred_unclbr.tolist() for y_pred_unclbr in y_pred_unclbr_repeat],
               'proba_pred_unclbr_repeat': [proba_pred_unclbr.tolist() for proba_pred_unclbr in proba_pred_unclbr_repeat],
               'score_unclbr_repeat': score_unclbr_repeat,
               'confus_mtx_unclbr_repeat': [cm_unclbr.tolist() for cm_unclbr in confus_mtx_unclbr_repeat],
               'y_pred_calibr_repeat': [y_pred_calibr.tolist() for y_pred_calibr in y_pred_calibr_repeat],
               'proba_pred_calibr_repeat': [proba_pred_calibr.tolist() for proba_pred_calibr in proba_pred_calibr_repeat],
               'score_calibr_repeat': score_calibr_repeat,
               'confus_mtx_calibr_repeat': [cm_calibr.tolist() for cm_calibr in confus_mtx_calibr_repeat]
               }
    ...
    filename = config.FILE_RESULTS_CALIBRATE.format(timestamp)
    # print out timestamp
...
if __name__ == '__main__':
    ...
    y_true_repeat, y_pred_unclbr_repeat, proba_pred_unclbr_repeat, score_unclbr_repeat, confus_mtx_unclbr_repeat, \
    y_pred_calibr_repeat, proba_pred_calibr_repeat, score_calibr_repeat, confus_mtx_calibr_repeat = \
        run_calibr_repeat_cv(df_data, decisor, opts_cv, opts_score, opts_pipe, hyperparams, seed=seed)

    # save results
    save_results_calibr_cv(decisor, opts_cv, opts_score, opts_pipe, hyperparams, seed,
                           y_true_repeat, y_pred_unclbr_repeat, proba_pred_unclbr_repeat, score_unclbr_repeat, confus_mtx_unclbr_repeat,
                           y_pred_calibr_repeat, proba_pred_calibr_repeat, score_calibr_repeat, confus_mtx_calibr_repeat)
